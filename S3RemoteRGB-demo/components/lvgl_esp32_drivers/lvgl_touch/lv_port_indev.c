...
void lv_port_indev_init(void)
{
    ...
    lv_group_add_obj(group, ui_ButtonLast);
    lv_group_add_obj(group, ui_ButtonNew);
    lv_group_add_obj(group, ui_ButtonSet);*/
